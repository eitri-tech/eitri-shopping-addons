...
[Vtex Ads](https://www.newtail.com.br/) is the leading Retail Media solution in Latin America, supporting major retailers in building a strategy to monetize their digital assets.
...
- [Website](https://www.newtail.com.br/)
- [Dashboard](https://app.newtail.com.br/)
- [Documentation](https://newtail-media.readme.io/reference/overview)

## AddonService - Integration

The `AddonService` handles communication between your Eitri application and [Vtex Ads](https://www.newtail.com.br/) Retail Media API. It provides helper methods to fetch personalized content (such as banners) and notify user interactions like impressions and views.
...
- **publisherId**: Your Vtex Ads publisher UUID.
...
Sends an event notification to Vtex Ads, used for tracking impressions, views or clicks of media.
...
```
- **url**: URL provided by Vtex Ads API for impression or view tracking.
